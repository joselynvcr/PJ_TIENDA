...
public class Usuario implements Serializable {
   ...
   // @NotBlank(message = "Ingrese su perfil, sino como sabemos..?")
    ...
    public Usuario(String u_nombres, String u_Paterno, String u_Materno, String u_dni, String u_Direccion, String u_perfil, String u_correo, String username, String u_password, String u_telefono) {
    ...
    public Usuario(Integer u_id, String u_nombres, String u_Paterno, String u_Materno, String u_dni, String u_Direccion, String u_perfil, String u_correo, String username, String u_password, String u_telefono) {
        this.u_id = u_id;
        this.u_nombres = u_nombres;
        this.u_Paterno = u_Paterno;
        this.u_Materno = u_Materno;
...
//    }
    ...
    @Override
    public String toString() {
        return "Usuario{" + "u_id=" + u_id + ", u_nombres=" + u_nombres + ", u_Paterno=" + u_Paterno + ", u_Materno=" + u_Materno + ", u_dni=" + u_dni + ", u_Direccion=" + u_Direccion + ", u_perfil=" + u_perfil + ", u_correo=" + u_correo + ", username=" + username + ", u_password=" + u_password + ", u_telefono=" + u_telefono + '}';
    }
