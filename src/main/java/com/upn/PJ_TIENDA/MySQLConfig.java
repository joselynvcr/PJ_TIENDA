...
@EnableJpaRepositories(
    entityManagerFactoryRef = "proyectoEntityManagerFactory",
    transactionManagerRef = "proyectoTransactionManager",
    basePackages = {"com.upn.PJ_TIENDA.dao"}
...
public class MySQLConfig {
    ...
    @Bean(name = "proyectoEntityManagerFactory")

    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        LocalContainerEntityManagerFactoryBean em = new LocalContainerEntityManagerFactoryBean();
        em.setDataSource(userDatasource());
        em.setPackagesToScan("com.upn.PJ_TIENDA.entidad");
    ...
    @Bean(name = "proyectoTransactionManager")
